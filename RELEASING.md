...
5. Load the project through `chrome://extensions` and manually test optional-project and automatic-project setup, Jira start/stop, popup manual start/stop, Worked today, Jira progress below/equal/above estimate, Markdown copy, billable and non-billable timers, timer switching, automatic Work Log sync, manual Work Log confirmation, and retry behavior.
...
Create and push a tag that exactly matches the manifest version. For version 0.5.1:
